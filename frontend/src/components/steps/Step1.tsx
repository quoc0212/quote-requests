  ...
  return (
    <form onSubmit={handleSubmit(onNext)} noValidate>
      <div className="form-card__header">
        <div className="form-card__step-badge">{t('steps.step')} 1 {t('steps.of')} 5</div>
      ...
      <div className="form-grid">
        ...
        {/* Phone */}
        <div className="form-group">
          <label className="form-label" htmlFor="phone">{t('step1.phone')}</label>
          <input
            id="phone"
            type="tel"
        ...
        {/* Company */}
        <div className="form-group">
          <label className="form-label" htmlFor="company_name">{t('step1.company')}</label>
          <input
            id="company_name"
            type="text"
